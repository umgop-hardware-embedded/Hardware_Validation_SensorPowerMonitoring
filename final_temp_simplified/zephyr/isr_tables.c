...
struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	{(const void *)0x23c15, (ISR)0x23c19}, /* 0 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 1 */
	{(const void *)0x2430c, (ISR)0x23a21}, /* 2 */
