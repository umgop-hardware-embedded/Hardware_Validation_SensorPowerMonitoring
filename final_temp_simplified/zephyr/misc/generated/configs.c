...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_BLE_OUTPUT_TEXT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_BLE_OUTPUT_DEFAULT, 0);
